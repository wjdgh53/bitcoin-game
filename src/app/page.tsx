      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <div className="flex gap-4 justify-center">
            <Link 
              href="/dashboard"
              className="px-8 py-4 bg-orange-500 hover:bg-orange-600 rounded-lg font-bold text-lg transition-colors flex items-center gap-2"
            >
            ...
            <Link 
              href="/reports"
              className="px-8 py-4 border-2 border-orange-500 hover:bg-orange-500/10 rounded-lg font-bold text-lg transition-colors flex items-center gap-2"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">
            ...
            <h3 className="text-xl font-bold mb-3">실시간 트레이딩</h3>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">
            ...
            <h3 className="text-xl font-bold mb-3">성취 시스템</h3>
            <p className="text-gray-100">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">
            ...
            <h3 className="text-xl font-bold mb-3">AI 교육 콘텐츠</h3>
            <p className="text-gray-100">
